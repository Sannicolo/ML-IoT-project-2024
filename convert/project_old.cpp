...
void classifyImage() {
  // Set the input array with the values from resizedImage
  for (unsigned int i = 0; i < IN_VEC_SIZE; i++) {
  ...
  // Determine the class based on the output values in the y array
  int maxIndx = 0;
